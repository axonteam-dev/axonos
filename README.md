...
Every day axonOS gets better, with new features and capabilities appearing, and each of you can make a meaningful contribution to the system. But before you contribute, you **should** read the information about styles, rules, and specifics in docs/CODING_STYLE.md and CONTRIBUTING.md. The main thing is not absolute skill and knowledge in OSDev, but desire and enthusiasm (though knowledge wouldn't hurt :D).
